...
public class ResponseMessage {
    ...
    public static final String SUCCESS_SEND_OTP = "successfully send OTP, please check email to verify";
    public static final String SUCCESS_DELETE_DATA = "successfully delete data";
    public static final String SUCCESS_VALIDATE_OTP = "token has been validated";
